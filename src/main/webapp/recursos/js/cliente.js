...
function listarCliente() {
    ...
    $.get("ec", {"opc": 1}, function (data) {
        ...
        for (var i = 0; i < x.length; i++) {
            $("#tablita").append("<tr><td>" + (i + 1) + "</td><td>" + x[i].sucursal + "</td><td>" + x[i].cliente + "</td><td>" + x[i].venta + "</td><td><a href='#' onclick='editar(" + x[i].idcliente + ")' class='edit'><i class='far fa-edit'></i></a></td><td><a href='#' onclick='del(" + x[i].idcliente + ")' class='del'><i class='fas fa-trash-alt'></i></a></td></tr>");
        }
    });
}
function agregar() {
